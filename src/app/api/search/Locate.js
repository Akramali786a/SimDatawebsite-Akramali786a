function Locate(value, value1 = value) {
	var location = "";
	let cnic = value1.toString();
	...
	if (Province == 1) {
		...
		if (Division == 1) {
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "BALAKOT,";
						...
						location += "KALA DHAKA,";
					else if (Counsil == 3) location += "MANSEHRA,";
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					location += "KARAK,";
					if (Counsil == 1)
						location += "BANDA DAUD SHAH,";
					else if (Counsil == 2) location += "KARAK,";
					else if (Counsil == 3)
						location += "TAKHT NUSRATI,";
				}
			} else if (District == 3) {
				if (Tehsil == 0) {
					location += "KOHAT,";
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "BARHA,";
						...
						location += "MAULA GHAURI,";
				}
			} else if (District == 3) {
				location += "KARAM,";
				if (Tehsil == 0) {
					if (Counsil == 1)
						location += "CENTRAL KARAM AGENCY,";
					else if (Counsil == 2)
						location += "LOWER KARAM AGENCY,";
					else if (Counsil == 3)
						location += "UPPER KARAM AGENCY,";
				}
			} else if (District == 4) {
				location += "MEHMAND,";
				if (Tehsil == 0) {
					if (Counsil == 1)
						location += "UTMAAN KHAIL (AMBER) {,";
						...
						location += "UPPER MEHMAND,";
					else if (Counsil == 7)
						location += "YAKKA GHUND,";
				}
			} else if (District == 5) {
		...
		if (Division == 1) {
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1)
						location += "RAJAN PUR (QABAILI ILAQA) {,";
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 0) location += "FAISLABAD,";
						...
						location += "FAISALABAD CITY,";
					else if (Counsil == 3)
						location += "FAISALABAD SADAR,";
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "CHINIOT,";
						...
						location += "AHMAD PUR SIAL,";
					else if (Counsil == 5)
						location += "ATHARA HAZARI,";
				}
			} else if (District == 3) {
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1)
						location += "JALALPUR PIRWALA,";
					else if (Counsil == 2)
						location += "MULTAN CITY,";
					else if (Counsil == 3)
						location += "MULTAN SADAR,";
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "ATTOCK,";
						...
						location += "HASSAN ABDAAL,";
					else if (Counsil == 4) location += "JAND,";
					else if (Counsil == 5)
						location += "PINDI GHAIB,";
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "CHAKWAL,";
						...
						location += "CHOA SAEEDAN SHAH,";
					else if (Counsil == 3) location += "TALAGANG,";
					else if (Counsil == 4)
						location += "KALAR KAHAR,";
				}
			} else if (District == 3) {
				location += "JHELUM,";
				if (Tehsil == 0) {
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "GOTH DADU,";
						...
						location += "KHAIRPUR NATAN SHAH,";
					else if (Counsil == 4) location += "KOTRI,";
					else if (Counsil == 5) location += "MEHARR,";
					else if (Counsil == 6)
						location += "SEHOHAN SHARIF,";
					else if (Counsil == 7)
						location += "THANO BOLA KHAN,";
				}
			} else if (District == 3) {
				location += "HYDERABAD,";
				if (Tehsil == 0) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "GHORHABARHI,";
						...
						location += "MIRPUR BATHORO,";
					else if (Counsil == 6)
						location += "MIRPUR SAAKRO,";
					else if (Counsil == 7)
						location += "SHAH BANDAR,";
				...
				if (Tehsil == 0) {
					if (Counsil == 1)
						...
						location += "BULRREY SHAH KAREEM,";
					else if (Counsil == 3)
						location += "TANDO GHULAM HAIDER,";
				}
			} else if (District == 7) {
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "SAJAWAL JUNEJO,";
						...
						location += "QABO SAEED KHAN,";
					else if (Counsil == 6)
						location += "SHAHDAD KOT,";
					else if (Counsil == 7) location += "WAARH,";
				}
			} else if (District == 5) {
				location += "KASHMOR,";
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1) location += "GANDAVAH,";
						...
						location += "KACHI BHAAG,";
					else if (Counsil == 4)
						location += "KACHI SUNNI,";
					else if (Counsil == 5)
						location += "KACHI MACHA,";
					else if (Counsil == 6)
						location += "KACHI DHADR,";
				}
			} else if (District == 4) {
				location += "NASEERABAD,";
				if (Tehsil == 0) {
		...
		if (Division == 1) {
			...
			if (District == 1) {
				...
				if (Tehsil == 0) {
					if (Counsil == 1)
						location += "FATEHPUR THAKIALA NAKIAAL,";
