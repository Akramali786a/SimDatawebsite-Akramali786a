...
function Page(props) {
	return (
		<div className={"container-fluid"} style={{maxHeight:"calc(100svh - 60px)",overflowY:"auto",overflowX:"hidden",overflowWrap:"anywhere",padding:"10px"}}>
			<style
        ...
        <strong>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="subtitle">
              Last updated <bdt className="question">April 17, 2024</bdt>
            </span>
          </span>
        </strong>
      </span>
      ...
      <span style={{ color: "rgb(127, 127, 127)" }}>
        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
          <span data-custom-class="body_text">
            This Cookie Policy explains how{" "}
			  <bdt className="question">Pak Services</bdt> ("
        ...
        <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
          <span data-custom-class="body_text">
            <bdt className="question">https://www.pakservices.online</bdt>
          </span>
        </span>
        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
          <span data-custom-class="body_text">
        ...
        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
          <span data-custom-class="body_text">
            Cookies set by the website owner (in this case,{" "}
			  <bdt className="question">Pak Services</bdt>) are called
				  ...
				  >
                    ...
                    <td style={{ display: "inline-block", marginLeft: 5 }}>
                      <span
						  style={{ color: "#8b93a7", wordBreak: "break-all" }}
					  >
                        A session cookie used to check if the user’s browser
                        supports cookies.
                      </span>
                    </td>
                  </tr>
        ...
        <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              technologies, please
              <bdt className="block-component" /> contact us at
              <bdt className="statement-end-if-in-editor" />:
            </span>
          </span>
        </span>
      ...
      <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
        <bdt className="question">
          <span data-custom-class="body_text">Bhalwal Sargodha Pakistan</span>
        </bdt>
        <span data-custom-class="body_text">
          <bdt className="block-component" />
        </span>
      ...
      <span data-custom-class="body_text">
        <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
          <bdt className="question">Bhalwal</bdt>
          <bdt className="block-component" />,{" "}
			<bdt className="question">Punjab</bdt>
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />{" "}
			<bdt className="question">40410</bdt>
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />
          <bdt className="block-component" />
        </span>
      ...
      <span data-custom-class="body_text">
        <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
          <bdt className="statement-end-if-in-editor">
            Phone: <bdt className="question">+923144709452</bdt>
          </bdt>
        </span>
      </span>
					<span data-custom-class="body_text">
