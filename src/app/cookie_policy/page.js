        ...
        <div>
          <p style={{ fontSize: 15, lineHeight: "1.5" }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              ...
              >
                <span data-custom-class="body_text">
                  These cookies are used to make advertising
                  messages more relevant to you. They perform
                  functions like preventing the same ad from
                  continuously reappearing, ensuring that ads
                  are properly displayed for advertisers, and
                  in some cases selecting advertisements that
        ...
        <div>
          <p style={{ fontSize: 15, lineHeight: "1.5" }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              ...
              >
                <span data-custom-class="body_text">
                  These are cookies that have not yet been
                  categorized. We are in the process of
                  classifying these cookies with the help of
                  their providers.
                </span>
              </span>
            </span>
            ...
            >
              ...
              >
                <span data-custom-class="body_text">
                  ...
                  <bdt className="block-component" /> contact
                  us at
                  <bdt className="statement-end-if-in-editor" />
                  :
                </span>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span data-custom-class="body_text">
            ...
            >
              <bdt className="statement-end-if-in-editor">
                Phone:{" "}
                <bdt className="question">+923144709452</bdt>
              </bdt>
            </span>
          </span>
          <span data-custom-class="body_text">
