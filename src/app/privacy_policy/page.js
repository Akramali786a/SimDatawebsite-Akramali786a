...
export default function Page() {
    return (
        <div className="container-fluid" style={{overflowY:"auto",overflowWrap:"anywhere" ,overflowX:"hidden",maxHeight:"calc(100svh - 60px)"}}>
            <div>
                <div>
                    <strong>
                ...
                <div>
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        <span style={{ fontSize: 15 }}>
                            <span data-custom-class="body_text">
                                ...
                                <span style={{ color: "rgb(0, 58, 250)" }}>
                                    <bdt className="question">
                                        www.pakservices.online/protectme
                                    </bdt>
                                </span>
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                        ...
                        <a data-custom-class="link" href="#otherlaws">
                            ...
                            >
                                9. DO OTHER REGIONS HAVE SPECIFIC PRIVACY
                                RIGHTS?
                            </span>
                        </a>
                        <span style={{ fontSize: 15 }}>
                            ...
                            >
                                <span data-custom-class="body_text">
                                    <strong>
                                        ...
                                        a variety of reasons, depending on how
